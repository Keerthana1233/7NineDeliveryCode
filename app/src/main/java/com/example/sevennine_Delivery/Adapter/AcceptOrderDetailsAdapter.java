...
public class AcceptOrderDetailsAdapter extends RecyclerView.Adapter<AcceptOrderDetailsAdapter.MyViewHolder>  {
    private List<OrderDetailBean> productList;
    Activity activity;
    Fragment selectedFragment;
    String name;
    public static CardView cardView;
    public AcceptOrderDetailsAdapter(Activity activity, List<OrderDetailBean> moviesList) {
